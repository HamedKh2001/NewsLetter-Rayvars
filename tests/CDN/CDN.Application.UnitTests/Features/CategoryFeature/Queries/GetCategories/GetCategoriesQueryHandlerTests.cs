...
namespace CDN.Application.UnitTests.Features.CategoryFeature.Queries
{
    public class GetCategoriesQueryHandlerTests
    {
        ...
        {
            new Category { Id = 1, Title = "Category 1", IsActive = true, CreatedDate = createdDate.AddDays(-1) },
            new Category { Id = 2, Title = "Category 2", IsActive = true, CreatedDate = createdDate.AddDays(-2) },
            new Category { Id = 3, Title = "Category 3", IsActive = true, CreatedDate = createdDate.AddDays(-3) },
            new Category { Id = 4, Title = "Category 4", IsActive = true, CreatedDate = createdDate.AddDays(-4) },
            new Category { Id = 5, Title = "Category 5", IsActive = true, CreatedDate = createdDate.AddDays(-5) }
        };
        ...
        {
            new CategoryDto { Id = 3, Title = "Category 3", IsActive = true, CreatedDate = createdDate.AddDays(-3) },
            new CategoryDto { Id = 4, Title = "Category 4", IsActive = true, CreatedDate = createdDate.AddDays(-4) },
            new CategoryDto { Id = 5, Title = "Category 5", IsActive = true, CreatedDate = createdDate.AddDays(-5) }
